...
class Staff_Directory_Admin {
	...
	public function save_staff_directory_meta_fields() {
		...
		$staff_directory_job_position = sanitize_text_field( $_POST['staff_directory_job_position'] );
		update_post_meta($post->ID, "staff_directory_job_position", $staff_directory_job_position);
